...
| `tracker/BOARD.md` | Build phase status and open flags, build phases only; its narrative paragraphs moved to Plan.md on 2026-09-24 | the `task-tracker` skill. The UI fix loop never writes it | `## Status counts` | none recorded |
