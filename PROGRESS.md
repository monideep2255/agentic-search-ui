...
- ~~One useful source of gene-to-disease information, OMIM, is still switched off.~~ SWITCHED ON on 22 September, with its safety filter connected first. Asking about one gene now shows that gene's OMIM entry and never another gene's: in ten live checks, a question about GCK kept its own entry and dropped nine that OMIM's own search had ranked above it. On the practice site, waiting to be confirmed.
...
3. Confirm on the practice site that a question about the GCK gene shows OMIM's glucokinase entry and no other gene's.
...
| ~~OMIM, a useful source of gene-to-disease information, is switched off~~ | SWITCHED ON 22 September with its safety filter connected first; ten live checks showed the right gene every time. On the practice site, waiting to be confirmed |
