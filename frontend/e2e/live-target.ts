 ...
 * ## Why this exists
 *
 * Every piece of evidence in `docs/build/UI_feedback.md` was gathered against
 ...
 * produced it. Committing one under `frontend/e2e/evidence/` without
 * recording which app answered produces evidence that cannot be compared
 * against a later run, which is the failure `docs/build/UI_feedback.md` hit from the
