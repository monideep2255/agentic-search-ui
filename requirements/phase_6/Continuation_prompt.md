...
- WORK "NEXT, IN ORDER" FROM ITS CUTOFF. Three answers for a fresh session, one line each:
  ...
  - WHAT AWAITS THE PRODUCT OWNER'S RETEST: items 7 to 22 in `testing/Shipped_2026-09-22.md` (17 to 22 are the isolate search, whose twelve queries and workflow are `testing/Product/queries/Isolate_search_queries_and_workflow.md`), plus the four one-look checks (11.14, 11.36, 9.12, 8.4).
