...
Every component file in `.claude/` (skill, agent, rule, hook) and every Python module under `src/system_03_search_agent/` should make its dependencies explicit. This prevents silent breakage when files move or get deleted.
