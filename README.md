...
Next: Step 6.2, the reconciliation pause. Build phase 2.2 (deterministic cite-or-refuse, Layer 1 provenance) closed 2026-08-03 and completes the Step 6.1 prototype group. Tools for Layers 2 and 3 not yet wired (build phases 3.1 to 3.5). Build order: 26 numbered phases (1.0 to 7.1) in Section 25 of the [Technical specification](requirements/Technical_specification.md).
