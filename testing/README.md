...
| See where every feature stands, what is next, and where the last session stopped | `UI_fix_plan.md`, the ordered work list and the single owner of per-item status |
