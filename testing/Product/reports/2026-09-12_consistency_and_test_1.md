...
| R7 | Sign-in box centred between header and footer | Section 5 | ✅ Built in set 2, not pushed yet |
| R8 | The white box keeps one width from progress to answer, across every search | Sections 3 and 6 | ✅ Built in set 2, not pushed yet |
| R9 | Header and footer fixed in place, with a stable content area, so the footer no longer jumps | Section 4 | ✅ Built in set 2, not pushed yet |
| R10 | Smooth transitions between home, progress and answer | Section 4 | ✅ Built in set 2, not pushed yet |
| R11 | Header and footer both in the lighter NCBI blue | Section 10, question 1 | ✅ Built in set 2, not pushed yet |
| R12 | New search as a filled blue button with white text, distinct from Stop | Section 7 | ✅ Built in set 2, not pushed yet |
