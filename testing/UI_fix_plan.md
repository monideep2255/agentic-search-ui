...
| 11.13 | The same readable format in both Plain language and Researcher | Live | Checked live: the same heading and table structure in both modes |
...
| 11.16 | Approved: signal the write step as it starts, reveal sentences at reading pace, then send each checked sentence as soon as it is ready | In progress | The screen parts are live. The backend part is being built in an isolated copy and lands on develop only after you finish sharing the prototype |
