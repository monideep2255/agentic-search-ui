...
|---|---|---|
| The answer answers the question instead of listing what was found | 12.10 | IN PROGRESS 2026-09-23. DECIDED by the product owner the same day, with 12.9: option B, change what the grounding gate accepts so a faithful synthesis survives. Their words: "It should synthesize and ensure that it is synthesizing from the paper". Design in 12.10's row |
| The sources chip and the trust line agree with each other | 12.11 | IN PROGRESS 2026-09-23, directed by the product owner. A regression from 12.8 the same day: the line counts citations and the list counts distinct pages |
| Broken sentences and repeated records in the answer | 12.12 | IN PROGRESS 2026-09-23, directed by the product owner. An orphan fragment starting lowercase with a stray quote mark, a paragraph opening "Another is titled" with no first, and the same records shown up to three times |
...
| Plain language and researcher stop returning the same text | 12.9 | IN PROGRESS 2026-09-23. DECIDED by the product owner: option B, built as 12.10. Once the model's own prose survives the gate, the two depths differ because the model already writes them differently |
