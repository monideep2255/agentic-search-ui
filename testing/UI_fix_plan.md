...
|---|---|---|
| The trust line stops undercounting an answer's sources | 12.8 | FIXED 2026-09-23, awaiting the product owner's retest. It counted distinct DATABASES, which is right for "confirmed by N independent sources" and wrong for "based on N sources". Two counts now |
