"""Does the Guard-tier classifier still refuse what the widened allowlist now
...
Run from the repository root:
    python testing/Developer/reports/2026-09-23_set12/probe_guard_verdicts.py
"""
import asyncio
import os
import pathlib
...
async def main() -> None:
    ...
    rows = []
    for expected, questions in (("admit", SHOULD_ADMIT), ("refuse", SHOULD_REFUSE)):
        for q in questions:
