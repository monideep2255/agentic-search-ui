"""The seven questions from testing/User-feedback, each asked twice: once as a
...
Run from the repository root:
    python testing/Developer/reports/2026-09-23_set12/run_both_depths.py
"""
import asyncio
import json
import pathlib
...
OUT = pathlib.Path(__file__).parent / "both_depths"
...
async def main() -> None:
    ...
    for key, question in QUESTIONS:
        for depth in ("plain_language", "researcher"):
            ...
            try:
                result = await measure(question, depth, show=False)
    ...
    print("wrote both_depths/all.jsonl")
