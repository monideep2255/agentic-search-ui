...
OUT = pathlib.Path(__file__).parent / "runs_guarded"
OUT.mkdir(exist_ok=True)

from local_loop_run_depth import measure

QUESTIONS = [
    # The two answers that carried a verdict and a misattribution on the
    # checked run, re-asked after the two exact guards were added.
...
async def main() -> None:
    ...
    print("wrote runs_guarded/all.jsonl")
